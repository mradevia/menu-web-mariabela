...
export const DEFAULT_MENU: MenuData = {
  desayunos: {
    ...
    icon: "Coffee",
    items: [
      { id: 2, name: "Huevos al Gusto", price: 90, ingredients: "Salchicha, jamón, estrellados, rancheros, divorciados, a la mexicana, tocino o a la albañil.", group: "Huevos", image: "/IMAGENES/1.png" },
      { id: 15, name: "Huevos Mariabela", price: 105, ingredients: "Huevos revueltos bañados en salsa de guajillo.", group: "Huevos", image: "/IMAGENES/1.png" },

      { id: 3, name: "Omelette al Gusto", price: 105, ingredients: "Champiñón, jamón, espinaca, tocino, quesos o chorizo.", group: "Omelettes", image: "/IMAGENES/1.png" },
      { id: 4, name: "Omelette Gourmet", price: 119, ingredients: "Espinaca fresca y queso de cabra.", group: "Omelettes", tags: ["Gourmet"], image: "/IMAGENES/1.png" },
      ...
      { id: 5, name: "Molletes Tradicionales (2 pzs.)", price: 85, ingredients: "Frijol refrito, jamón, queso gratinado y pico de gallo.", group: "Molletes", image: "/IMAGENES/1.png" },
      { id: 6, name: "Molletes con Chorizo o Champiñón", price: 95, ingredients: "Frijol refrito, queso gratinado y tu elección de chorizo o champiñón.", group: "Molletes", image: "/IMAGENES/1.png" },

      { id: 9, name: "Chilaquiles", price: 80, ingredients: "Verdes, rojos o divorciados.", group: "Chilaquiles", image: "/IMAGENES/1.png" },
      { id: 1, name: "Volcán de Chilaquiles", price: 129, ingredients: "Pan sourdough con orden de chilaquiles, pollo, crema y queso gratinado.", group: "Chilaquiles", tags: ["Estrella"], image: "/IMAGENES/1.png" },

      { id: 11, name: "Enchiladas (3 pzas.)", price: 107, ingredients: "Verdes, rojas o divorciadas, rellenas de pollo.", group: "Enchiladas", image: "/IMAGENES/1.png" },
      { id: 10, name: "Enfrijoladas (3 pzas.)", price: 107, ingredients: "Bañadas en salsa de frijol con crema, queso y aguacate.", group: "Enchiladas", image: "/IMAGENES/1.png" },
      { id: 12, name: "Enchiladas Suizas (3 pzas.)", price: 135, ingredients: "Cubiertas con salsa suiza, queso gratinado y ajonjolí.", group: "Enchiladas", tags: ["Premium"], image: "/IMAGENES/1.png" },
      ...
      { id: 7, name: "Croissant de Jamón", price: 99, ingredients: "Jamón, queso panela, queso manchego, lechuga y jitomate.", group: "Panes & Sándwiches", image: "/IMAGENES/1.png" },
      { id: 8, name: "Bagel de Jamón", price: 99, ingredients: "Bagel con huevo, jamón, queso manchego, queso panela, lechuga y jitomate.", group: "Panes & Sándwiches", image: "/IMAGENES/1.png" },
      { id: 17, name: "Sándwich Gratinado", price: 107, ingredients: "Pan de caja con jamón, lechuga, jitomate, queso gratinado y huevo estrellado.", group: "Panes & Sándwiches", image: "/IMAGENES/1.png" },
      { id: 14, name: "Desayuno Mariabela", price: 105, ingredients: "Orden de waffles acompañados con huevo estrellado o al gusto.", group: "Panes & Sándwiches", tags: ["De la Casa"], image: "/IMAGENES/1.png" },
      ...
      { id: 22, name: "Pechuga Napolitana", price: 140, ingredients: "Pechuga asada bañada en salsa pomodoro con queso gratinado.", group: "Especialidades", tags: ["Premium"], image: "/IMAGENES/8.png" },
      { id: 20, name: "Wraps", price: 95, ingredients: "Tortilla de harina u hoja de lechuga rellena de jitomate, cebolla, elote, champiñón, atún o pollo.", group: "Especialidades", image: "/IMAGENES/1.png" },
      { id: 18, name: "Sincronizadas", price: 80, ingredients: "Dos tortillas de harina rellenas de jamón y queso manchego, acompañadas de salsa mexicana.", group: "Especialidades", image: "/IMAGENES/1.png" },
      { id: 19, name: "Tacos Campestres", price: 95, ingredients: "Tres tacos preparados en hoja de lechuga con pollo, champiñón, elote y jitomate.", group: "Especialidades", tags: ["Light"], image: "/IMAGENES/1.png" },
      { id: 21, name: "Árabe Mariabela", price: 99, ingredients: "Jamón de pavo, queso panela, manzana, lechuga y pepino.", group: "Especialidades", image: "/IMAGENES/1.png" },
      { id: 23, name: "Sopesitos Sencillos (3 pzs.)", price: 85, ingredients: "Frijol refrito, crema, queso y lechuga.", group: "Especialidades", image: "/IMAGENES/1.png" },
      { id: 16, name: "Sope Light", price: 95, ingredients: "Nopal con pollo deshebrado, bañado en salsa verde, lechuga y queso.", group: "Especialidades", tags: ["Light"], image: "/IMAGENES/1.png" },
      { id: 24, name: "Sopesitos de Pollo o Carne Asada (3 pzs.)", price: 120, ingredients: "Frijol refrito, crema, queso y lechuga.", group: "Especialidades", image: "/IMAGENES/1.png" },
      { id: 13, name: "Waffles Dulces", price: 85, ingredients: "Acompañados con frutos rojos, chocolate y crema dulce.", group: "Especialidades", image: "/IMAGENES/1.png" },
    ],
  },
  entradas: {
    title: "Entradas",
    ...
    items: [
      ...
      { id: 32, name: "Papas al Ajo con Arrachera", price: 115, ingredients: "250 g de papas a la francesa sazonadas con ajo, chile de árbol, aceite de oliva y especias cajún. Acompañadas de 120 g de jugosa arrachera.", tags: ["Favorito"], image: "/IMAGENES/2.png" },
    ],
  },
  ensaladas: {
    title: "Ensaladas",
    ...
    icon: "Salad",
    items: [
      { id: 50, name: "Ensalada César", price: 115, ingredients: "Base de lechuga, queso parmesano, crotones, pechuga de pollo asada y aderezo césar.", image: "/IMAGENES/3.png" },
      ...
      { id: 52, name: "Ensalada Frutal", price: 140, ingredients: "Base de lechuga, arándanos, ajonjolí caramelizado, semillas de girasol, betabel, manzana, pera, fresa, mango, germen de alfalfa, pasta y jitomate cherry.", tags: ["Fresh"], image: "/IMAGENES/3.png" },
      ...
      { id: 57, name: "Ensalada Escandinavia", price: 145, ingredients: "Base de lechuga, jitomate cherry, láminas de salmón ahumado, pan crujiente, queso philadelphia y cebollín.", tags: ["Premium"], image: "/IMAGENES/3.png" },
  ...
  paninis: {
    ...
    items: [
      ...
      { id: 71, name: "Panini de Pechuga Asada", price: 155, ingredients: "Pan artesanal con mantequilla, mayonesa, pepino, jitomate, germen, lechuga y pechuga de pollo asada.", group: "Paninis", image: "/IMAGENES/5.png" },
      ...
      { id: 76, name: "Hamburguesa Clásica", price: 150, ingredients: "Pan brioche, carne de res 100%, cebolla caramelizada, jitomate, lechuga y 130 g de papas a la francesa.", group: "Hamburguesas", image: "/IMAGENES/5.png" },
      { id: 77, name: "Hamburguesa Mariabela", price: 205, ingredients: "Pan brioche con 200 g de arrachera, guacamole, mermelada de tocino, queso fundido, aros de cebolla, jitomate, lechuga, mayonesa del chef y 130 g de papas a la francesa.", group: "Hamburguesas", tags: ["Best Seller"], image: "/IMAGENES/5.png" },
    ],
  },
  pastas: {
    title: "Pastas",
    ...
    icon: "Pizza",
    items: [
      { id: 80, name: "Lasaña Boloñesa", price: 195, ingredients: "Receta secreta de la casa con carne de res, pomodoro y mozzarella gratinada.", tags: ["Best Seller"], image: "/IMAGENES/6.png" },
      { id: 81, name: "Pasta Alfredo", price: 100, ingredients: "Pasta larga con crema, vino blanco y queso parmesano." },
      { id: 82, name: "Pasta Carbonara", price: 115, ingredients: "Pasta larga con tocino, vino blanco, crema y queso parmesano.", image: "/IMAGENES/6.png" },
      ...
      { id: 84, name: "Frutti di Mare", price: 170, ingredients: "Camarones y pescado al ajo, vino blanco y queso parmesano.", tags: ["Premium"], image: "/IMAGENES/6.png" },
      ...
      { id: 94, name: "Pasta Salmone", price: 145, ingredients: "Salmón, crema, cebollín, cebolla, ajo, vino blanco y queso parmesano.", tags: ["Gourmet"], image: "/IMAGENES/6.png" },
  ...
  pizzas: {
    ...
    icon: "Flame",
    items: [
      { id: 100, name: "Pizza Pepperoni", price: 120, ingredients: "Tomate, mozzarella y pepperoni.", image: "/IMAGENES/7.png" },
      { id: 106, name: "Pizza Napolitana", price: 130, ingredients: "Tomate, mozzarella, pepperoni, champiñón, cebolla y jalapeño." },
      { id: 101, name: "Pizza Prosciutto", price: 125, ingredients: "Tomate, mozzarella y jamón serrano.", tags: ["Italia"], image: "/IMAGENES/7.png" },
      { id: 102, name: "Pizza Hawaiana", price: 125, ingredients: "Tomate, mozzarella, jamón y piña." },
      { id: 103, name: "Pizza Camarón", price: 170, ingredients: "Tomate, mozzarella, camarón, pimiento morrón y cebolla.", tags: ["Premium"] },
      { id: 104, name: "Pizza Cuatro Quesos", price: 125, ingredients: "Tomate, mozzarella, gouda, parmesano y manchego.", image: "/IMAGENES/7.png" },
  ...
  especialidades: {
    ...
    items: [
      ...
      { id: 130, name: "Salmón al Limón", price: 245, ingredients: "Salmón a la plancha con salsa cremosa de limón y vino blanco. Acompañado de ensalada fresca y pasta al burro.", tags: ["Recomendado"], image: "/IMAGENES/8.png" },
      ...
      { id: 118, name: "Melanzane alla Parmigiana", price: 120, ingredients: "Láminas de berenjena gratinadas con salsa pomodoro y queso parmesano.", tags: ["Vegetariano"], image: "/IMAGENES/8.png" },
  ...
  cortes: {
    ...
    items: [
      ...
      { id: 132, name: "Rib Eye (350 g)", price: 295, ingredients: "Corte marmoleado al grill. Guarnición a elegir: papas a la francesa o pasta.", tags: ["Premium"], image: "/IMAGENES/9.png" },
  ...
  bebidas: {
    ...
    items: [
      ...
      { id: 144, name: "Malteadas", price: 60, ingredients: "Vainilla, chocolate o fresa. Base de leche y helado. Leche deslactosada +$10.", group: "Bebidas Frías" },
      ...
      { id: 158, name: "Jarra de Clericot", price: 150, ingredients: "Vino tinto con fruta de temporada.", group: "Para Compartir", image: "/IMAGENES/2.png" },
      ...
      { id: 156, name: "Copa de Vino de la Casa", price: 95, ingredients: "Vino de la house tinto o blanco. Vinos sujetos a disponibilidad.", group: "Vino", image: "/IMAGENES/2.png" },
  ...
  postres: {
    ...
    icon: "IceCream",
    items: [
      { id: 180, name: "Helado Tempura", price: 85, ingredients: "Helado frito con cobertura crujiente.", image: "/IMAGENES/8.png" },
  ...
  infantil: {
    ...
    items: [
      ...
      { id: 193, name: "Mini Pizza", price: 95, ingredients: "Jamón, hawaiana o pepperoni.", image: "/IMAGENES/5.png" },
